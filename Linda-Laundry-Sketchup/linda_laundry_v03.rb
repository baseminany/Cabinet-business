...
module LindaLaundry_V03
  extend self

  MASTER_NAME    = "Linda_Laundry_V03"
  PREVIOUS_NAMES = ["Linda_Laundry_V02_Shell", "Linda_Laundry_V01_Shell",
  ...
  def report
    bar = "=" * 74
    puts "\n#{bar}\n  LINDA LAUNDRY / MUDROOM  -  V03  -  VALIDATION REPORT\n#{bar}"
    ...
    puts "[Color]  Light walnut throughout (doors, carcasses, crown, shiplap)."
