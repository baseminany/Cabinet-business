...
export const PRESETS: PresetSpec[] = [
  {
    ...
    highlights: ['30″ wide × 33″ tall — toddler reach', '3 display ledges with book rails', 'Natural white oak, rounded edges', 'Cuts from a single plywood sheet'],
  ...
  },
  {
    ...
    category: 'Kids',
    blurb: 'A standing platform that lets your toddler reach the counter and help in the kitchen. Birch ply, ships in a box.',
    highlights: ['Platform built to your counter height', 'Enclosed back panel + front rail', '3/4″ birch ply, rounded edges', 'Housed-joint construction with a base stretcher'],
  ...
  },
  {
    ...
    category: 'Storage',
    blurb: 'Three clean wood ledges for the living room, office, or hallway — books, plants, frames, and everyday display.',
    highlights: ['Three 36″ × 8″ deep shelves, 2″ chunky profile', 'Hidden steel bracket — floats off the wall', 'Walnut or white oak', 'Ships flat in one small box'],
    items: [
  ...
  },
  {
    ...
    category: 'Coffee',
    blurb: 'Two walnut shelves for above the coffee counter — mugs on one, beans and gear on the other. The one-morning coffee corner.',
    highlights: ['Two 30″ × 8″ deep shelves', 'Hidden steel brackets — clean float', 'Walnut or white oak', 'Ships in one small box'],
    items: [
  ...
  },
  {
    ...
    highlights: ['36″ × 18″ tall × 16″ deep', 'One large open bin — no lid, no pinch points', 'Fits under most windowsills', 'Soft white painted, rounded edges'],
